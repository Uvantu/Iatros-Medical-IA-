...
const origin =
  process.env.IGGY_ALLOWED_ORIGIN ||
  'http://localhost:5173';
...
server.listen(port, '127.0.0.1', () => {
  console.log(
    'IGGY Live Engine listening on http://127.0.0.1:' + port
  );
});
